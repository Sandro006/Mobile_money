    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <div class="card p-4 shadow-sm">
                ...
                <p class="text-muted small">Envoyez instantanément du crédit à un autre bénéficiaire. Les frais réglementaires s'appliquent sur votre solde.</p>
                <hr>
                ...
                <form action="/operation/transfert" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="numero_destinataire" name="numero_destinataire" class="form-control form-control-lg font-monospace text-center" placeholder="Ex: 0331234567" required>
                    </div>

                    <!-- Montant à transférer -->
                    <div class="mb-3">
                        <label for="montant" class="form-label fw-bold">Montant à envoyer (Ar)</label>
